...
import com.primecredit.tool.speech.lium.services.LIUMSpeakerDiarizationHandler;
...
public class ApplicationService {
	...
	@Autowired
	private LIUMSpeakerDiarizationHandler liumHandler;
	...
	public void run() {
		...
		while(wavIter.hasNext()) {
			...
			//(3) LIUM Speaker Diarization
			List<DiarizationSpeech> dsList = new ArrayList<DiarizationSpeech>();
			dsList = liumHandler.diarization(sourceFileName);
