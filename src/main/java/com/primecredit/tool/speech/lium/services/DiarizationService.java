...
public class DiarizationService extends Thread {
	...
	static ArrayList<DiarizationService> diarizationList;
	...
	public boolean isThreadAlive() {
		for (DiarizationService diarization : diarizationList) {
	...
	public void ester2DiarizationCorpus(Parameter parameter) throws DiarizationException, Exception {
		...
		diarizationList = new ArrayList<DiarizationService>(nbThread);

		for (int i = 0; i < nbThread; i++) {
			diarizationList.add(new DiarizationService());
	...
	public static void startDiarization(String[] args) {
		try {
			// Reset All
			diarizationList = new ArrayList<DiarizationService>();
			...
			if (parameter.show.isEmpty() == false) {
				DiarizationService diarization = new DiarizationService();
